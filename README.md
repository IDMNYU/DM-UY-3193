...
5% - Students will be expected to document their work on Github. You may also set up a blog on a site like Wordpress or Medium for supplementary narrative documentation. If you already have your own hosted website and would like to blog there, that works, too. Github documentation will be expected to be coupled with comprehensive comments in your code and a thorough README file with each repository.
